...
function OnboardingDialog() {
	...
	const onCreateVault = () => {
		void (async () => {
			...
			if (vaultStore.getState().vaultPath) setZoteroOfferOpen(true);
		})();
	};
	...
	return (
		<>
			...
			<Dialog open={zoteroOfferOpen} onOpenChange={setZoteroOfferOpen}>
				<DialogContent>
					<DialogHeader>
					...
					<DialogFooter>
						...
						<Button type="button" onClick={onImportZotero}>
							{t("vault.zotero")}
						</Button>
					</DialogFooter>
				</DialogContent>
